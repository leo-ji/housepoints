...
define('PAGE_TITLE', "Add House Event");
...
<div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <h3 class="box-title">House Points Event Form</h3>
                </div>
                <form action="add-event-process.php" method="post" role="form">
                <div class="box-body">
                    <p><i class="fa fa-warning"></i>&nbsp;&nbsp;<strong>Warning:</strong> This form will add house points immediately after submission.</p>
