...
<html class="lockscreen">
    ...
    <body>
        ...
        <div class="center">            
            ...
            <!-- User name -->
            <div class="lockscreen-name">Oops, you broke the Internet</div>
            
            <!-- START LOCK SCREEN ITEM -->
            <div class="text-center">
                <p>Error 404. Item not found.</p>

            </div><!-- /.lockscreen-item -->

            <div class="lockscreen-link">
                <a href="/admin/login.php">Signing in might help.</a>
            </div>            
        </div><!-- /.center -->
